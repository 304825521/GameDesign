...
namespace FlowCanvas.Nodes
{
    ...
    public class FindNode : FlowControlNode
    {
        ...
        void searchNode()
        {
            searchNodeList = graph.GetAllNodesOfType<FlowNode>().ToList().FindAll(i =>
            {
        ...
        void searchNestedNode()
        {
            foreach (var _o in graph.GetAllNestedGraphs<Graph>(true))
            {
                ...
                if (o != graph)
                {
                    List<FlowNode> l = o.GetAllNodesOfType<FlowNode>().ToList().FindAll(i =>
                    {
        ...
        void RefreshListenereck()
        {
            ...
            eventNodeList = graph.GetAllNodesOfType<EventNode>().ToList();
            CustomFunctionEventList = graph.GetAllNodesOfType<CustomFunctionEvent>().ToList();

            macroNodeList = graph.GetAllNodesOfType<MacroNodeWrapper>().ToList();
            nestedFCNodeList = graph.GetAllNodesOfType<FlowNestedFlow>().ToList();
            nestedFSMNodeList = graph.GetAllNodesOfType<FlowNestedFSM>().ToList();
            nestedBTNodeList = graph.GetAllNodesOfType<FlowNestedBT>().ToList();
