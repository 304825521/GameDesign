...
namespace NodeCanvas.Editor
{
    ...
    public partial class GraphEditor : EditorWindow
    {
        ...
        void OnGUI() {
...

            {
                ...
                GUI.BeginClip(canvasRect, pan / zoomFactor, default(Vector2), false);
                {
                    ...
                    DrawPings();
                    //SL--
                    DoCanvasRectSelection(canvasRect);
                }
                GUI.EndClip();
            }
        ...
        bool CheckSumOK() {
            ...
            if ( targetOwner != null ) {
                ...
                if ( EditorUtility.IsPersistent(targetOwner) && targetOwner.graphIsBound ) {
                    ...
                    //SL--
                    var dtnRect = new Rect(0, 0, 200, 50);
                    dtnRect.center = new Vector2(canvasRect.width / 2, TOP_MARGIN + 170);
                    if (GUI.Button(dtnRect, "ClearUselessNestedAssets"))
                    {
                        ...
                        {
                            NestedUtility.DeleteAllUselessBoundAsset(rootGraph);
                        }
                    }
            ...
            if ( !ReferenceEquals(curr, currentGraph) ) {
                ...
                if (currentGraph != null)
                {
                    currentGraph.initialReferencesUpdated = false;
                    Debug.Log("update BlackBoard");
                }
#endif
        ...
        //SL--
        internal static List<IGraphElement> currentMultiSelection = new List<IGraphElement>();
        //SL--
