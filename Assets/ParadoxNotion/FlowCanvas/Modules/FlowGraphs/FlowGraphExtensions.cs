...
namespace FlowCanvas
{
    ...
    public static class FlowGraphExtensions
    {
        ...
        //SL--
        public static void Finalize(FlowNode node, Port context, object dropInstance)
        {
            ...
            foreach ( var _info in infos ) {
                ...
                if ( contextPort != null ) {
                    ...
                    if ( invokeMethod != null ) {
                        ...
                        {
                            //SL--------------
                            if (!isCallableFunction && invokeMethod.ReturnType != typeof(void) && invokeMethod.ReturnType != typeof(System.Collections.IEnumerator))
                            {
                                continue;
                            }
        ...
        public static void ConvertNodesGroup(List<Node> originalNodes, Macro newMacro, MacroNodeWrapper wrapper)
        {
            ...
            {
                UnityEditor.Undo.RecordObject(graph, "Convert To GroupMacro");
            }
#endif
